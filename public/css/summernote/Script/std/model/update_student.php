...
if(isset($_POST["do"])&&($_POST["do"]=="update_student")){
    ...
    if(isset($_POST["user"])&&($_POST["user"]=="Admin")){
        ...
        header("Location: view/all_student.php?do=alert_from_update&msg=$msg&grade_id=$grade_id");

    }

    if(isset($_POST["user"])&&($_POST["user"]=="Teacher")){

        header("Location: view/my_student.php?do=alert_from_update&msg=$msg&grade_id=$grade_id");
        
    }

    if(isset($_POST["user"])&&($_POST["user"]=="Student")){

        header("Location: view/student_profile.php?do=alert_from_update&msg=$msg");
