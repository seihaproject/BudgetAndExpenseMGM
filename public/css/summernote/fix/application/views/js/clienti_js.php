...
dataString = "nome=" + escape(nome) + "&cognome=" + escape(cognome)  + "&indirizzo=" + escape(indirizzo)  + "&citta=" + escape(citta)  + "&telefono=" + escape(telefono)  + "&email=" + escape(email)  + "&commenti=" + escape(commenti)  + "&vat=" + escape(vat)  + "&cf=" + escape(cf)  + "&token=<?=$_SESSION['token'];?>";
				jQuery.ajax({
					type: "POST",
					url: url,
					data: dataString,
                ...
                dataString = "nome=" + escape(nome)  + "&cognome=" + escape(cognome)  + "&indirizzo=" + escape(indirizzo)  + "&citta=" + escape(citta)  + "&telefono=" + escape(telefono)  + "&id=" + escape(id)  + "&email=" + escape(email)  + "&commenti=" + escape(commenti)  + "&vat=" + escape(vat)  + "&cf=" + escape(cf)  + "&token=<?=$_SESSION['token'];?>";
				jQuery.ajax({
					type: "POST",
					url: url,
					data: dataString,
		...
		jQuery.ajax({
			...
			success: function (data) {
				if (typeof data.nome === 'undefined') {
                    ...
                    var string = "<div class=\"btn-group btn-group-justified left\"><button data-dismiss=\"modal\" class=\"btn btn-default\" type=\"button\"><i class=\"fa fa-reply\"></i> <?= $this->lang->line('js_torna_indietro');?></button></div><div class=\"btn-group btn-group-justified right\"><button id=\"elimina_c\" data-dismiss=\"modal\" data-num=\"" + escape(num) + "\" class=\"btn btn-danger\" type=\"button\"><i class=\"fa fa-trash-o \"></i> <?= $this->lang->line('js_elimina');?></button><button data-dismiss=\"modal\" id=\"modifica_c\" href=\"#clientimodal\" data-toggle=\"modal\" data-num=\"" + escape(num) + "\" class=\"btn btn-success\"><i class=\"fa fa-pencil\"></i> <?= $this->lang->line('modifica');?></button></div>";
